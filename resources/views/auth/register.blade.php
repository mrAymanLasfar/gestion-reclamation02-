            ...
            <form method="POST" action="{{ route('register') }}" class="clearfix">
                ...
                <div class="input_field"> 
                  <div class="input_container">
                      <div class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" style="color: #000;" class="bi bi-person" viewBox="0 0 16 16">
                ...
                <div class="input_field">
                  <div class="input_container">
                    <div class="icon">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" style="color: #000;" class="bi bi-envelope-at" viewBox="0 0 16 16">
                ...
                <div class="input_field">
                  <div class="input_container">
                    <div class="icon">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" style="color: #000;" class="bi bi-file-lock2" viewBox="0 0 16 16">
