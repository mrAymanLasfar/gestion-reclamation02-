...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Gestion de reclamtion</title>
...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Gestion de reclamation</title>
        ...
        <style>
            ...
            body{margin:0;background-color: white;} /* Change background to white */
            a{background-color:transparent}
            [hidden]{display:none}
    ...
    <body class="antialiased">
        <div class="relative flex items-center justify-center min-h-screen bg-white sm:items-center py-4 sm:pt-0"> <!-- Center content and set background to white -->
            @if (Route::has('login'))
                <div class="center"> <!-- Centering the content -->
                    <div class="title">Gestion de reclamation</div> <!-- Title above the buttons -->
                    @auth
                        <a href="{{ url('/dashboard') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Dashboard</a>
                    @else
                        <a href="{{ route('login') }}" class="btn">Log in</a>  <!-- Apply button styles -->
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="btn mt-2 mr-2">Register</a> <!-- Apply button styles -->
                        @endif
                    @endauth
                </div>
            @endif
